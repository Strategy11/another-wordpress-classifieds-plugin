...
<div class="awpcp-media-manager" data-breakpoint-class-prefix="awpcp-media-manager" data-breakpoints="420,620,800" data-bind="{ template: 'awpcp-media-manager-template' }"></div>
        ...
        <ul class="awpcp-uploaded-files-list clearfix" data-bind="foreach: { data: videos, as: 'video' }">
            <li data-bind="css: $root.getFileCSSClasses( video ), attr: { id: $root.getFileId( video ) }">
                ...
                <ul class="awpcp-uploaded-file-actions clearfix">
                    ...
                    <li class="awpcp-uploaded-file-action awpcp-uploaded-file-approve-action" data-bind="visible: $root.showAdminActions() &amp;&amp; !isApproved()"><a title="<?php echo esc_attr( __( 'Approve Video', 'another-wordpress-classifieds-plugin' ) ); ?>" data-bind="click: $root.approveFile"></a></li>
                    <li class="awpcp-uploaded-file-action awpcp-uploaded-file-reject-action" data-bind="visible: $root.showAdminActions() &amp;&amp; isApproved()"><a title="<?php echo esc_attr( __( 'Reject Video', 'another-wordpress-classifieds-plugin' ) ); ?>" data-bind="click: $root.rejectFile"></a></li>
                </ul>
                <span class="awpcp-spinner awpcp-spinner-visible awpcp-uploaded-file-spinner" data-bind="visible: isBeingModified"></span>
                <div class="awpcp-uploaded-file-primary-label" data-bind="visible: isPrimary"><?php echo esc_html(  __( 'Primary Video', 'another-wordpress-classifieds-plugin' ) ); ?></div>
            </li>
        </ul>
    </div>
                ...
                <tr data-bind="css: $root.getFileCSSClasses( file ), attr: { id: $root.getFileId( file ) }">
                    ...
                    <td>
                        <ul class="awpcp-uploaded-file-actions clearfix">
                            ...
                            <li class="awpcp-uploaded-file-action awpcp-uploaded-file-approve-action" data-bind="visible: $root.showAdminActions() &amp;&amp; !isApproved()"><a title="<?php echo esc_attr( __( 'Approve File', 'another-wordpress-classifieds-plugin' ) ); ?>" data-bind="click: $root.approveFile"></a></li>
                            <li class="awpcp-uploaded-file-action awpcp-uploaded-file-reject-action" data-bind="visible: $root.showAdminActions() &amp;&amp; isApproved()"><a title="<?php echo esc_attr( __( 'Reject File', 'another-wordpress-classifieds-plugin' ) ); ?>" data-bind="click: $root.rejectFile"></a></li>
