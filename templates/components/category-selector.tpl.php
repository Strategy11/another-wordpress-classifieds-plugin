<?php if ( $label ): ?>
<label class="awpcp-category-dropdown-label" for="awpcp-category-dropdown-<?php echo esc_attr( $hash ); ?>"><?php echo $label ?><?php echo $required ? '<span class="required">*</span>' : ''; ?></label>
<?php endif; ?>
...
<script type="text/javascript">var categories_<?php echo $hash; ?> = <?php echo wp_json_encode( $javascript ); ?>;</script>
