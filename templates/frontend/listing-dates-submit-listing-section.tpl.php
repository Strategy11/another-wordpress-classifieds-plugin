...
?><div class="awpcp-listing-dates-submit-listing-section awpcp-submit-listing-section">
    <h2 class="awpcp-submit-listing-section-title js-handler"><?php echo esc_html_x( 'Classified dates', 'listing dates submit listing section', 'another-wordpress-classifieds-plugin' ); ?><span></span></h2>
