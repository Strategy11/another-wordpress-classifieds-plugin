...
?><p class="awpcp-form-field awpcp-clearfix   awpcp-form-spacer">
    ...
    <input class="awpcp-textfield inputbox <?php echo esc_attr( $validator ); ?>" id="<?php echo esc_attr( $html['id'] ); ?>" type="text" size="50" name="<?php echo esc_attr( $html['name'] ); ?>" value="<?php echo awpcp_esc_attr( $value ); // XSS Okay. ?>" />
