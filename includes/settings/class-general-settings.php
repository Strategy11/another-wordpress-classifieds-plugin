...
class AWPCP_GeneralSettings {
    ...
    public function register_settings( $settings ) {
        ...
        $settings->add_setting( $key, 'activatelanguages', __( 'Turn on transalation file (POT)', 'another-wordpress-classifieds-plugin' ), 'checkbox', 0, __( "Enable translations. WordPress will look for an AWPCP-&lt;language&gt;.mo file in AWPCP's languages/ directory of the main plugin and premium modules. Example filenames are: AWPCP-en_EN.mo, AWPCP-es_ES.mo. You can generate .mo files using POEdit and the AWPCP.pot or AWPCP-en_EN.po files included with the plugin.", 'another-wordpress-classifieds-plugin' ) );
