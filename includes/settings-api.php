...
class AWPCP_Settings_API {
	...
	public function register_settings() {
		...
		$this->add_setting( $key, 'browse-categories-page-name', __( 'Browse Categories page', 'another-wordpress-classifieds-plugin' ), 'textfield', 'Browse Categories', __( 'Name for Browse Categories page.', 'another-wordpress-classifieds-plugin' ) );
		...
		$this->add_setting( $key, 'verifyemailsubjectline', __( 'Subject for Verification email', 'another-wordpress-classifieds-plugin' ), 'textfield', __( "Verify the email address used for Ad [ADTITLE]", 'another-wordpress-classifieds-plugin' ), __( 'Subject line for email sent out to verify the email address', 'another-wordpress-classifieds-plugin' ) );
		$this->add_setting( $key, 'verifyemailbodymessage', __( 'Body for Verification email', 'another-wordpress-classifieds-plugin' ), 'textarea', __( "Hello [AUTHORNAME] \n\nYou recently posted the Ad [ADTITLE] to [BLOGNAME]. \n\nIn order to complete the posting process you have to verify your email address. Please click the link below to complete the verification process. You will be redirected to the website where you can see your Ad. \n\n[VERIFICATIONLINK] \n\nAfter you verify your email address, the administrator will be notified about the new Ad. If moderation is enabled, your Ad will remain in a disabled status until the administrator approves it.\n\n[BLOGNAME]\n\n[BLOGURL]", 'another-wordpress-classifieds-plugin' ), __('Message body text for Verification email', 'another-wordpress-classifieds-plugin' ) );
