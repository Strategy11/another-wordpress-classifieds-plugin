        ...
        register_post_type(
            ...
            array(
                'labels'               => array(
                    ...
                    'singular_name'      => __( 'Classified', 'another-wordpress-classifieds-plugin' ),
                    'all_items'          => __( 'All Classifieds', 'another-wordpress-classifieds-plugin' ),
                    'add_new'            => _x( 'Add New', 'awpcp_listing', 'another-wordpress-classifieds-plugin' ),
                    'add_new_item'       => __( 'Add New Classified', 'another-wordpress-classifieds-plugin' ),
                    'edit_item'          => __( 'Edit Classified', 'another-wordpress-classifieds-plugin' ),
                    'new_item'           => __( 'New Classified', 'another-wordpress-classifieds-plugin' ),
                    'view_item'          => __( 'View Classified', 'another-wordpress-classifieds-plugin' ),
