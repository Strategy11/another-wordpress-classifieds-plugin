<form action="<?php echo esc_attr( $google_checkout_url ); ?>" method="post">
    ...
    <?php $text = __("Your listing has not been fully submitted yet. To complete the process you need to click the link below.", 'another-wordpress-classifieds-plugin') ?>
    ...
    <input type="image" src="<?php echo esc_attr( $button_url ); ?>" alt="<?php echo esc_attr( __( "Pay With Google Checkout", 'another-wordpress-classifieds-plugin' ) ); ?>" /></form>
</form>
