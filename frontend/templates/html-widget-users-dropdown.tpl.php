...
<select id="<?php echo esc_attr( $args['id'] ); ?>" name="<?php echo esc_attr( $args['name'] ); ?>" class="<?php echo esc_attr( implode( ' ', $args['class'] ) ); ?>" dropdown-field>
    ...
    <option value="<?php echo esc_attr( $user->ID ); ?>"
        <?php if ( $args['include-full-user-information'] ): ?> data-user-information="<?php echo esc_attr( wp_json_encode( $user ) ); ?>"<?php endif; ?>
        <?php echo $args['selected'] == $user->ID ? 'selected="selected"' : ''; ?>>
