...
<select class="awpcp-category-dropdown awpcp-dropdown <?php echo $required ? 'required' : ''; ?>" id="awpcp-category-dropdown" target="<?php echo esc_attr( $hash ); ?>" chain="<?php echo esc_attr( join( ',', $chain ) ); ?>" next-default-option="<?php echo esc_attr( $labels['default-option-second-level'] ); ?>">
    <option class="default" value=""><?php echo esc_html( $labels['default-option-first-level'] ); ?></option>
...
<select class="awpcp-category-dropdown  awpcp-dropdown <?php echo $required ? 'required' : ''; ?>" id="awpcp-category-dropdown" name="<?php echo esc_attr( $name ); ?>">
    <option value=""><?php echo esc_html( $labels['default-option-first-level'] ); ?></option>
