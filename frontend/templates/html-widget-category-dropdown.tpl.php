...
<select class="awpcp-category-dropdown awpcp-dropdown <?php echo $required ? 'required' : ''; ?>" id="awpcp-category-dropdown" target="<?php echo $hash; ?>" chain="<?php echo esc_attr( join( ',', $chain ) ); ?>">
