...
<div>
	<form class="awpcp-details-form" id="adpostform" name="adpostform" action="<?php echo $this->url() ?>" method="post">
        ...
        <p class="awpcp-form-spacer">
            ...
            <textarea class="awpcp-textarea textareainput required" id="ad-details" name="ad_details" rows="10" cols="50" data-max-characters="<?php echo $form['characters_allowed']; ?>" data-remaining-characters="<?php echo $form['remaining_characters'] ?>"><?php /* Content alerady e scaped if necessary. Do not escape again here! */ echo $form['ad_details']; ?></textarea>
        </p>
