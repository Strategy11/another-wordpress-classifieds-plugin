...
<div>
	<form class="awpcp-details-form" id="adpostform" name="adpostform" action="<?php echo esc_attr( $this->url() ) ?>" method="post">
        ...
        <?php if (string_starts_with($text, 'http://', false) || string_starts_with($text, 'https://', false)): ?>
            <a href="<?php echo esc_attr( $text ); ?>" target="_blank"><?php echo esc_html( ( "Read our Terms of Service", 'ad details form', "AWPCP" ) ); ?></a>
        <?php else: ?>
            <label><?php echo esc_html( ( "Terms of service:", 'ad details form', "AWPCP" ) ); ?><?php echo $required['terms-of-service'] ? '*' : ''; ?></label>
        ...
        <?php endif ?>
            ...
            <label class="inline" for="terms-of-service"><?php echo esc_html( ( 'I agree to the terms of service', 'ad details form', 'AWPCP' ) ); ?></label>
