<p>
    ...
    <input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo $instance['title']; ?>" />
</p>
...
<p>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'hide-empty' ) ); ?>"><?php _e('Hide empty categories.', 'AWPCP'); ?></label>
    <br/>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show-parents-only' ) ); ?>"><?php _e('Show parent categories only.', 'AWPCP'); ?></label>
    <br/>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show-ad-count' ) ); ?>"><?php _e('Show Ad count.', 'AWPCP'); ?></label>
</p>
