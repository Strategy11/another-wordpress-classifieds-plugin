...
<form class="awpcp-reply-to-ad-form" method="post" name="myform">
    ...
    <p class="awpcp-form-spacer">
        ...
        <textarea id="awpcp-contact-message" class="awpcp-textarea textareainput required" name="awpcp_message" rows="5" cols="90%"><?php echo esc_textarea( $form['awpcp_contact_message'] ); ?></textarea>
