        ...
        <div class="postbox">
            ...
            <div class="inside">
                <ul>
                    ...
                    <li><?php _e("Number of active listings currently in the system", 'another-wordpress-classifieds-plugin'); ?>: <strong><?php echo $totallistings; ?></strong></li>

                    <?php $totallistings = countlistings(0); ?>
                    <li><?php _e("Number of inactive/expired/disabled listings currently in the system", 'another-wordpress-classifieds-plugin'); ?>: <strong><?php echo $totallistings; ?></strong></li>
                </ul>
