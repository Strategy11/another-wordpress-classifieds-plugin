...
<p><?php
    ...
    $content = str_replace( '{link_to_facebook_integration_documentation}', '<a href="">', $content );
...
<p><?php
    ...
    $content = str_replace( '{webhook_instructions_for_zapier}', '<a href="">', $content );
    $content = str_replace( '{/webhook_instructions_for_zapier}', '</a>', $content );
    $content = str_replace( '{webhook_instructions_for_ifttt}', '<a href="">', $content );
