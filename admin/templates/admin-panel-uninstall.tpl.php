...
<p>
    <?php echo __( 'Thank you for using AWPCP. You have arrived at this page by clicking the Uninstall link. If you are certain you wish to uninstall the plugin, please click the button at the bottom to proceed.', 'another-wordpress-classifieds-plugin' ); ?>
</p>
